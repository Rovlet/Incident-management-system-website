...
urlpatterns = [
    ...
    path('admin_panel/admin_ended/<int:pk>/pdf/', user_views.Pdf.as_view(), name='admin-raport'),
    ...
    path('admin_panel/admin_del/<int:pk>/', user_views.admin_del, name='admin-del'),
    ...
    path('cons_panel/cons_ended/<int:pk>/pdf/', user_views.Pdf.as_view(), name='cons-raport'),
    ...
    path('user_panel/user_ended/<int:pk>/pdf/', user_views.Pdf.as_view(), name='user-raport'),
    path('user_panel/user_questions/<int:pk>/', user_views.user_questions, name='user-questions'),
    path('user_panel/user_questions2/<int:pk>/', user_views.user_questions2, name='user-questions2'),
]
