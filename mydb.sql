...
--
-- Host: 127.0.0.1
-- Czas generowania: 26 Maj 2020, 11:08
...
('mhlt9s852n8q30qqtw7r0qw8f4wad0i7', 'YTIzYTljZmE5YjM5ZjE4ZjYxMGVlZjk4NjYzOWQ5YjFmZjg3MDQ0Yzp7Il9hdXRoX3VzZXJfaWQiOiIzIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiIyNTc3YWNkMjE0YTk3OWJlYTUzMmQ5Mzg3MDIxZTEzYWNlODZkMGM2In0=', '2020-06-08 19:39:47.208738');
...
(1, 'Podejrzana wiadomość e-mail | podejrzane załą'),
(2, 'Złośliwe oprogramowanie | trojan, banker, spy'),
(3, 'Oszustwa internetowe |fałszywa działalność w '),
(4, 'Włamania | serwer, aplikacja, konto, system, '),
(5, 'Utrata dostępności usługi | DoS, DDoS, sabota'),
(6, 'Naruszenia bezpieczeństwa informacji | nieupr'),
(7, 'Podatności | błędy w oprogramowaniu lub aplik'),
(8, 'Nielegalne treści'),
(9, 'Cyberterroryzm | działania o charakterze terr'),
...
(3, 'test', '2222-11-10 23:00:00.000000', NULL, 'estsett', NULL, 3, 1, 2, 1, 1);
...
('pbkdf2_sha256$180000$4vPd2fpap3DY$C1sW44uCs8ucuJB7AzylGtEULNsEOIl+Vt7gQ01hmpc=', '2020-05-25 12:34:04.084076', 1, 'bachi', '', '', 'bachi@test.pl', 1, 1, '2020-05-18 17:01:49.632285', 2, 1),
('pbkdf2_sha256$180000$4b4bgPPdmOvT$Ha9vm6xaFWdsRdoJKGxdsgphq7SsAh5rPoNB4Po87Ec=', '2020-05-25 19:39:47.116495', 0, 'cons', '', '', '', 1, 1, '2020-05-21 19:53:26.000000', 3, 2),
('pbkdf2_sha256$180000$QmRRqC6WHRlM$Qu9aWWvdTvCrH7xkbR9MagLVCagsbaRONIO6QRFm9GQ=', '2020-05-25 17:52:57.480144', 0, 'user', '', '', '', 0, 1, '2020-05-21 20:00:34.000000', 4, 3);
...
(2, 'test', 'test', '2002-11-11 01:02:00.000000', 'test', 'test', 'tets', 'wiem@sdsd.pl', '2020-11-11 10:11:00.000000', 0, 2, 4, 'test'),
(3, 'setse', 'etse', '2019-02-23 10:11:00.000000', 'tests', 'etset', 'test', 'ttt@ttt.pl', '1998-02-23 10:11:00.000000', 0, 3, 4, 'setse');
...
ALTER TABLE `kontakt`
  ...
  ADD KEY `kontakt_id_osoba_6c22f29d_fk_osoba_idOsoba` (`id_osoba`);
...
--
ALTER TABLE `detale_narazonych_systemow`
  MODIFY `idDetale_narazonych_systemow` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `kontakt`
  MODIFY `idKontakt` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `osoba`
  MODIFY `idOsoba` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `pracownik`
  MODIFY `idPracownik` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `sprawa`
  MODIFY `idSprawa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `zgloszenie`
  MODIFY `idZgloszenie` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT dla tabeli `zrodlo_incydentu`
--
ALTER TABLE `zrodlo_incydentu`
  MODIFY `idZrodlo_incydentu` int(11) NOT NULL AUTO_INCREMENT;
